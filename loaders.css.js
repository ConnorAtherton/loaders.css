$(function() {
  ...
  $('.loader-inner.dancing-lights-2').html(addDivs(2));
  $('.loader-inner.dancing-lights-4').html(addDivs(4));
  $('.loader-inner.dancing-lights-6').html(addDivs(6));
  $('.loader-inner.dancing-lights-8').html(addDivs(8));
